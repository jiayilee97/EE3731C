...
decrypted_txt_cur=decrypt(encrypted_txt,current_key);
logn_pr_cur=logn_pr_txt(decrypted_txt_cur, pr_trans);

decrypted_txt_new=decrypt(encrypted_txt,new_key);
logn_pr_new=logn_pr_txt(decrypted_txt_new, pr_trans);

if logn_pr_new >= logn_pr_cur
    accept_new_key=1;
    prob_accept=1;
elseif logn_pr_new< logn_pr_cur
    p = exp(logn_pr_new - logn_pr_cur);
    prob_accept=p;
